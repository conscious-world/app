...
class VRViewController: UIViewController , SCNSceneRendererDelegate, UIGestureRecognizerDelegate {
    ...
    @IBAction func playPausePlayer() {
        ...
        playingVideo = !playingVideo
        playButton.setImage(UIImage(named: (true == playingVideo) ? "ic_pause_circle_outline_white_48pt" : "ic_play_circle_outline_white_48pt"), forState: .Normal)
    }
